...
### *Clipboard* :clipboard: | [Wiki (KR)](https://ko.wikipedia.org/wiki/%ED%81%B4%EB%A6%BD%EB%B3%B4%EB%93%9C)
...
# *Test* | [Blog (KR)](https://angel927.tistory.com/150)
...
성능 테스트는 시스템 구성 요소가 특정 상황에서 어떤 성능을 보이는지 확인하기 위해 수행되는 테스트이다. 제품의 리소스 사용, 확장성 및 안정성도 이 테스트를 통해 검증할 수 있다. 성능 테스트는 load, endurance, volume, scalability, spike, and stress 테스트의 상위 집합이다.
